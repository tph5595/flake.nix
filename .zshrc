...
export PATH=~/dotfiles/bin:~/secrets/bin:~/.local/bin:$PATH
# export GOPATH=~/go
...
alias anyvpnui='/opt/cisco/anyconnect/bin/vpnui'
alias weka='~/Documents/Research/weka-3-8-4/weka.sh'
...
[ -f "/Users/taylor/.ghcup/env" ] && source "/Users/taylor/.ghcup/env" # ghcup-env